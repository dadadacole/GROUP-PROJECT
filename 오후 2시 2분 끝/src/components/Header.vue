    ...
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark border">
        ...
        <div :class="isNavShow ? 'collapse navbar-collapse show' : 'collapse navbar-collapse'">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <router-link class="navCardRecommendation nav-link" to="/CardRecommendation"> 카드 추천 </router-link>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <router-link class="navChallenge nav-link" to="/Challenge">무지출 챌린지</router-link>
                </li>
            </ul>
        </div>
        <div class="collapse navbar-collapse d-flex justify-content-end">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <router-link class="navListView nav-link" to="/Listview">회원가입/로그인</router-link>
                </li>
            </ul>
        </div>
    </nav>
